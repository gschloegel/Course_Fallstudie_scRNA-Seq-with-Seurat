...
\minisec{Pre-processing}\label{pre-processing}}
...
\minisec{Identification of highly variable features and
...
\minisec{Determine `dimensionality' of
...
\minisec{Cluster the cells}\label{cluster-the-cells}}
...
\minisec{Finding differentially expressed
...
\minisec{Visualization of the marker
...
\minisec{Rule 1: For every result, keep track of how it was
...
\minisec{Rule 2: Avoid manual data manipulation
...
\minisec{Rule 3. Archive the exact versions of all external
programs
...
\minisec{Rule 4: Version control all custom
...
\minisec{Rule 5: Record all intermediate results, when possible in
standardized
...
\minisec{Rule 6: For analyses that include randomness, note underlying
random
...
\minisec{Rule 7: Always store raw data behind
...
\minisec{Rule 8 Generate hierarchical analysis output, allowing layers
...
\minisec{Rule 9: Connect textual statements to underlying
...
\minisec{Rule 10: Provide public access to Scripts, runs, and
